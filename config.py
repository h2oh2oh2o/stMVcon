...
class Config(object):
    def __init__(self, config_file):
        ...
        self.n_neighbors = conf.getint("Model_Setup", "n_neighbors")
        self.n_neighbors1 = conf.getint("Model_Setup", "n_neighbors1")
        self.preprocess = conf.getboolean("Model_Setup", "preprocess")
        self.highly_genes = conf.getint("Model_Setup", "highly_genes")
        ...
        self.pca = conf.getint("Model_Setup", "pca")
        ...
        self.lamda = conf.getfloat("Model_Setup", "lamda")
        self.refine_radius = conf.getint("Model_Setup", "refine_radius")
